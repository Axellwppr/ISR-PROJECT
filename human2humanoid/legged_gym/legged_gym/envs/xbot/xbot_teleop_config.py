...
class XbotTeleopCfg(LeggedRobotCfg):
    ...
    class noise(LeggedRobotCfg.noise):
        ...
        class noise_scales:
            ...
            body_pos = 0.01  # body pos in cartesian space: 28x3
            body_lin_vel = 0.01  # body velocity in cartesian space: 28x3
    ...
    class asset(LeggedRobotCfg.asset):
        file = "{LEGGED_GYM_ROOT_DIR}/resources/robots/xbot/urdf/rel2.urdf"
        name = "xbot"
        foot_name = "ankle"
        penalize_contacts_on = []
        terminate_after_contacts_on = ["waist_roll_link", "shoulder", "hip", "knee"]
    ...
    class rewards(LeggedRobotCfg.rewards):
        ...
        soft_dof_pos_limit = (
            0.85  # percentage of urdf limits, values above this limit are penalized
        )
    ...
    class motion(LeggedRobotCfg.motion):
        ...
        motion_file = "{LEGGED_GYM_ROOT_DIR}/resources/motions/xbot/amass_all.pkl"

        skeleton_file = "{LEGGED_GYM_ROOT_DIR}/resources/robots/xbot/urdf/rel2.xml"
        marker_file = "{LEGGED_GYM_ROOT_DIR}/resources/objects/Marker/traj_marker.urdf"
        num_dof_pos_reference = 28
        num_dof_vel_reference = 28
        ...
        resample_motions_for_envs_interval_s = 200
        extend_head = False
        extend_hand = False


class XbotTeleopCfgPPO(LeggedRobotCfgPPO):
    class algorithm:
        # training params
        value_loss_coef = 1.0
